 ...
 */
export default function ProgramDrawerView({ program, variant, onClose, onOpenAlly, onPrimaryCta }) {
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="no-scrollbar flex-1 overflow-y-auto px-5 py-7 sm:px-9">
        <ProgramDetail program={program} onOpenAlly={onOpenAlly} variant={variant} />
      </div>
